...
const questions = [
	{
		...
		'questionText': [
			{optionA: "Man", optionB: "Woman"},
			{optionA: "Black", optionB: "White"},
			{optionA: "Red", optionB: "Blue"},
			{optionA: "Up", optionB: "Down"},
			{optionA: "Light", optionB: "Dark"},
			{optionA: "Car", optionB: "Bike"},
			{optionA: "Bed", optionB: "Sofa"},
			{optionA: "House", optionB: "Condo"},
			{optionA: "Yello", optionB: "Green"},
			{optionA: "Hot", optionB: "Cold"},
		],
		'video': {
