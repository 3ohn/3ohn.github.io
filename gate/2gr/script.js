...
const questionsU3 =[ 
    {
        ...
        "<p class='sentence'> He really <span>loves:likes</span> fish. </p>" +
        "<p class='sentence'> What kind of food <span>does</span> Mimi like?</p>" +
        "<p class='sentence'> She <span>likes</span> Thai food. </p>" +
        "<p class='sentence'> <span>Do</span> you and your parents like American food? </p>" +
        "<p class='sentence'> I like American food,</p>" +
...
const questionsU4 =[ 
    {
        ...
        "<p class='sentence'> She doesn't like to drive so she <span>always:usually</span> walks to work from Monday to Friday. </p>" +
        ...
        "<p class='sentence'> What about Lily? She <span>always:usually</span> stays with her parents. </p>" +
        ...
        "<p class='sentence'> She <span>usually:always</span> watches nursery rhymes.</p>" +
        "<p class='sentence'> She doesn't  like to stay home, so she <span>usually:always</span> says 'Daddy, let's go shopping'.</p>"
    }
];
...
const questionsU6 =[ 
    {
        ...
        "<p class='sentence'> You <span>weren't:were</span> in the USA yesterday, but John was there.</p>" +
...
const questionsU8 =[ 
    {
        ...
        "<p class='sentence'> She <span>is:seems</span> very friendly and smart, </p>" +
        "<p class='sentence'> so I <span>like</span> talking to her.  </p>" +
        "<p class='sentence'> She <span>looks:is</span> slim and beautiful, </p>" +
        ...
        "<p class='sentence'> She <span>looks:is</span> also beautiful but chubby, </p>" +
        "<p class='sentence'> and she <span>has</span> short curly hair. </p>" +
        "<p class='sentence'> She <span>is:seems</span> a hard working student. </p>" +
        "<p class='sentence'> What <span>is</span> she like? </p>" +
        "<p class='sentence'> She <span>seems:is</span> kind and outgoing. </p>" +
        "<p class='sentence'> What <span>does</span> Don look like? </p>" +
        "<p class='sentence'> He <span>looks:is</span> handsome. </p>" +
...
const questionsU12 =[ 
    {
        ...
        "<p class='sentence'> He's <span>going to rent:going to buy</span> an apartment there next week.</p>" +
        ...
        "<p class='sentence'> They <span>will:are going to</span> have a great business after graduation.</p>" +
        "<p class='sentence'> Then they <span>will:are going to</span> make a lot of money. </p>" +
        ...
        "<p class='sentence'> I <span>may:will</span> go to France or Germany. </p>" +
        "<p class='sentence'> I'm looking forward <span>meeting:seeing:visiting</span> all my friends again in Bangkok.</p>"
    }
];
